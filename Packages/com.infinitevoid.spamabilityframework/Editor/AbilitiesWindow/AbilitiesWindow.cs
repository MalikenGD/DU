...
namespace InfiniteVoid.SpamFramework.Editor.AbilitiesWindow
{
    public class AbilitiesWindow : EditorWindow
    {
        ...
        {
            AbilitiesWindow wnd = GetWindow<AbilitiesWindow>("Abilities", true);
            wnd.minSize = new Vector2(400, 400);
            wnd.Show();
            GetWindow<EffectsWindow.EffectsWindow>("Effects", typeof(AbilitiesWindow));
            GetWindow<ConditionsWindow.ConditionsWindow>("Conditions", typeof(AbilitiesWindow));
            GetWindow<ConditionalEffectsWindow.ConditionalEffectsWindow>("Conditional effects", typeof(AbilitiesWindow));
        }
