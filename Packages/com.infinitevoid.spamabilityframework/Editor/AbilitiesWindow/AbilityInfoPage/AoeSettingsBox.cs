...
namespace InfiniteVoid.SpamFramework.Editor.AbilitiesWindow.AbilityInfoPage
{
    public class AoeSettingsBox : VisualElement
    {
        ...
        {
            AddPropToElement("_areaOfEffectType", serializedAbility,parentBox, tooltip: "The type of physics shape to use when checking for targets inside the Area of Effect.");
