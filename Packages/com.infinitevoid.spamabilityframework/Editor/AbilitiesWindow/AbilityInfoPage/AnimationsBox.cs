...
namespace InfiniteVoid.SpamFramework.Editor.AbilitiesWindow.AbilityInfoPage
{
    ...
    {
        public AnimationsBox(SerializedObject serializedAbility, SerializedProperty animationsProp)
        {
            var animBox = CommonUI.CreateBox("Animations & Timings", this, helpUrl:"https://spam.infinitevoid.games/animations-and-timings.html");
