...
namespace InfiniteVoid.SpamFramework.Editor.EffectsWindow
{
    public class EffectsWindow : EditorWindow
    {
        ...
        public static void ShowWindow()
        {
            ...
            wnd.titleContent = EditorUtils.GetSPAMWindowTitle("Effects");
            wnd.Show();
        }
        ...
        private void OnEffectSelected(IEnumerable<object> objects)
        {
            ...
            var settingsBox = CreateBox("General settings", settingsWrapper, helpUrl: "https://spam.infinitevoid.games/effect-settings.html");
        ...
        private void AddPropsSpecificToEffectType(SerializedObject serializedEffect, AbilityEffectSO effectSO)
        {
            ...
            var specificSettingsBox = CreateBox("Effect specific settings", specificSettingsWrapper, helpUrl: "https://spam.infinitevoid.games/effect-settings.html");
