...
namespace InfiniteVoid.SpamFramework.Editor.ConditionsWindow
{
    public class ConditionsWindow : EditorWindow
    {
        ...
        public static void ShowWindow()
        {
            ...
            wnd.titleContent = EditorUtils.GetSPAMWindowTitle("Conditions");
            wnd.Show();
        }
        ...
        private void OnConditionSelected(IEnumerable<object> selectedConditions)
        {
            ...
            var settingsBox = CreateBox("General settings", settingsWrapper, helpUrl: "https://spam.infinitevoid.games/conditions.html");
