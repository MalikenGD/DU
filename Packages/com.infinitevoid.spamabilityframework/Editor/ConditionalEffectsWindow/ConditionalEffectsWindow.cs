...
namespace InfiniteVoid.SpamFramework.Editor.ConditionalEffectsWindow
{
    public class ConditionalEffectsWindow : EditorWindow
    {
        ...
        private void OnConditionalEffectSelected(IEnumerable<object> selectedConditionalEffects)
        {
            ...
            renameAssetButton.visible = conditionalEffectsSO.name != conditionalEffectsSO.Name && !conditionalEffectsSO.Name.IsNullOrWhitespace();
            ...
            var preconditionsList = new PreconditionsList.PreconditionsList(conditionalEffectsSO, serializedConditionalEffect);
