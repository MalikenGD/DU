...
{
	/// <summary>
	/// Workaround for broken object picker, taken from:
	/// https://github.com/adamgit/PublishersFork/blob/main/EditorForks/WorkaroundUnityUIToolkitBrokenObjectSelector.cs
	/// 
	/// Usage:
	...
	/// </summary>
    public static class CustomObjectPicker
    {
