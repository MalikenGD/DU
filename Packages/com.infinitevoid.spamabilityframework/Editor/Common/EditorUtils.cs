...
namespace InfiniteVoid.SpamFramework.Editor.Common
{
    ...
    public static class EditorUtils
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static ProjectilePool GetOrCreatePool(ProjectileAbilitySO projectileAbility)
        {
        ...
        private static Texture _spamIcon;
        public static GUIContent GetSPAMWindowTitle(string windowName)
        {
            if(!_spamIcon)
                _spamIcon = Resources.Load<Texture>("spam_icon");
            return new GUIContent(windowName, _spamIcon);
        }
    }
}