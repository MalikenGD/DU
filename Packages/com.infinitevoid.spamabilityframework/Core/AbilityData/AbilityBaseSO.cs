...
namespace InfiniteVoid.SpamFramework.Core.AbilityData
{
    ...
    public abstract class AbilityBaseSO : ScriptableObject, IAbilityData
    {
        ...
        public override bool Equals(object other)
        {
            ...
            if (other is AbilityBaseSO otherAbility)
                return _id == otherAbility._id;
        ...
        public bool HasPooledVfx()
        {
            if (!this.VFX) return false;
            return VFX.OnHitUseSharedPool;
        }
#if UNITY_EDITOR
        /// <summary>
        /// Set the ID of the ability. Used only in editor.
        /// ID is used for comparison, hashcode and equality.
