...
{
    [CreateAssetMenu(menuName = "SPAM Framework/Ability effects/Spawn particles", fileName = "spawnparticles.asset")]
    public class SpawnParticlesEffectSO : AbilityEffectSO
    {
            ...
            AbilityInvoker invoker)
        {
            ...
            SpamLogger.LogDebug(LOG_MODULE, $"Spawn particles {_particlePrefab.name} from effect at {spawnPos.ToString()} with lifetime {_particleLifeTime.ToString(CultureInfo.InvariantCulture)}");
