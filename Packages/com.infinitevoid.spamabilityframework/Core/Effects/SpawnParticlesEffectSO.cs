...
namespace InfiniteVoid.SpamFramework.Core.Effects
{
    ...
    public class SpawnParticlesEffectSO : AbilityEffectSO
    {
            ...
            AbilityInvoker invoker)
        {
            ...
            SpamLogger.LogDebug(_logModule, $"Spawn particles {_particlePrefab.name} from effect at {spawnPos.ToString()} with lifetime {_particleLifeTime.ToString(CultureInfo.InvariantCulture)}");
